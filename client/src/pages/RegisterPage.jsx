  ...
  return (
    <div className='min-h-[80vh] flex items-center justify-center flex-col'>
      ...
      >
          ...
          <Field name="name" type="text" className="w-full py-2 border-1 border-gray-400 rounded px-3 placeholder:font-pmedium outline-0" placeholder='Enter Your Name'/>
         ...
         <div className="flex mb-3 items-center justify-between">
            ...
            <div className="flex flex-col w-full ">
              <Field placeholder="Enter Captcha" name="captcha" className="w-full py-2 font-psemibold border-2 border-gray-400 rounded px-3 placeholder:font-pmedium outline-0"/>
         ...
         <div className="mb-3">
           <p className="text-end">
            ...
            className="font-psemibold text-indigo-600">Login</Link>
           </p>
         </div>
      </Form>
      </Formik>
